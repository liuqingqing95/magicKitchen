...
const ProgressBar = React.memo(
  ({
    ...
    const ProgressBarInnder = useCallback(
      ({
        progress = 0,
        position = [0, 0, 0],
        offsetZ = -0.5,
        ...
        return (
          <group
            position={[position[0], position[1] + 1, position[2] + offsetZ]}
          >
            {/* 外层：白色背景（同时作为 border） */}
    ...
    const {
      handleIngredientsApi: { handleIngredients },
